...
// decorator 3
class HTMLproductoDecorator extends ProductDecorator{
    getDetail(){
...
const commercialInfoProduct =
    new CommercialInfoProductDecorator(productComponent, "London", "Fuller's");
...
const htmlProductDecorator = new HTMLproductoDecorator(product);
